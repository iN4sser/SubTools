Public Class SubTools
    ...
    Private Sub RecordBtn_Click(sender As Object, e As EventArgs) Handles RecordBtn.Click
        ...
        ElseIf Res.Text = "" Then
            Shell("cmd.exe /k" + "ffmpeg -f gdigrab -r " + FPS.Text + " " + APBtn2.Text + " -i desktop -acodec copy " + SaveRecPath.Text + " -y")
        ElseIf ShowRegYes.Checked Then
            Shell("cmd.exe /k" + "ffmpeg -f gdigrab -r " + FPS.Text + " -offset_x 10 -offset_y 20 -video_size " + Res.Text + " -show_region 1 " + APBtn2.Text + " -i desktop -acodec copy " + SaveRecPath.Text + " -y")
        Else
            Shell("cmd.exe /k" + "ffmpeg -f gdigrab -r " + FPS.Text + " -offset_x 10 -offset_y 20 -video_size " + Res.Text + " " + APBtn2.Text + " -i desktop -acodec copy " + SaveRecPath.Text + " -y")
        End If
    End Sub
    ...
    Private Sub StartSplitting_Click(sender As Object, e As EventArgs) Handles StartSplitting.Click
        ...
        Else
            Shell("cmd.exe /k" + "ffmpeg -i " + SplitterTarget.Text + " -acodec copy -f segment -segment_time " + SegmentTime.Text + " -vcodec copy -reset_timestamps 1 -map 0 " + SplitOutputPath.Text + "_%03d" + SplitOutputExtension.Text + " -y ")
        End If
    End Sub
